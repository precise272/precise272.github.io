...
// Function to fetch book details by book ID using prepared statement
...
$stmt = $pdo->prepare("INSERT INTO choices (page_id, amount_of_choices, choice_text_1, target_page_1, choice_text_2, target_page_2, choice_text_3, target_page_3, choice_text_4, target_page_4) VALUES (?, 0, null, null, null, null, null, null, null, null)");
$stmt->execute([$pageId]);
...
try {
    ...
    if (isset($_POST['title'], $_POST['author'], $_POST['year'], $_POST['description'], $_POST['image_url'], $_POST['video_url'])) {
        // Extract form data
        $title = $_POST['title'];
        $author = $_POST['author'];
        $year = $_POST['year'];

...
function openChoiceModal(pageId, chapterId, amountOfChoices) {
    ...
    $('#saveChoiceModalBtn').on('click', function () {
        ...
        if (choiceText.trim() !== '') {
            ...
            createNewPageAndSaveChoice(pageId, chapterId, amountOfChoices, choiceText);
        } else {
...
function createNewPageAndSaveChoice(pageId, chapterId, amountOfChoices, choiceText) {
    // Create Page
    $.ajax({
        url: '/book/admin-portal/books/add-pages.php',
        type: 'POST',
        ...
        success: function (response) {
            ...
            // Optionally, reload choices for the current page after saving
            loadChoicesForPage(selectedBookId, chapterId, pageId, function (choices, pageId, chapterId, bookId, choiceId, amountOfChoices) {
